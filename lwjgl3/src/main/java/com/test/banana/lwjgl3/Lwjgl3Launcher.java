package com.test.banana.lwjgl3;

import com.badlogic.gdx.backends.lwjgl3.Lwjgl3Application;
import com.badlogic.gdx.backends.lwjgl3.Lwjgl3ApplicationConfiguration;
import com.test.banana.banana;
...
public class Lwjgl3Launcher {
    ...
    private static Lwjgl3Application createApplication() {
        return new Lwjgl3Application(new banana(), getDefaultConfiguration());
    }
    ...
    private static Lwjgl3ApplicationConfiguration getDefaultConfiguration() {
        ...
        //// This uses the dependency `com.asidik.libgdx:gdx-lwjgl3-angle` to function.
        //// You would need to add this line to lwjgl3/build.gradle , below the dependency on `gdx-backend-lwjgl3`:
        ////     implementation "com.asidik.libgdx:gdx-lwjgl3-angle:$gdxVersion"
